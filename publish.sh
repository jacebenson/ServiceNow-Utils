...
zip -r publish/snutils-chrome-base.zip . -x "*.DS_Store" -x "*.git*" -x ".jshintrc" -x ".docx" -x "*.sh" -x "*publish*" -x "*node_modules*"
...
zip -r publish/snutils-chrome-onprem.zip . -x "*.DS_Store" -x "*.git*" -x ".jshintrc" -x ".docx" -x "*.sh" -x "*publish*" -x "*node_modules*"
...
zip -r publish/snutils-firefox-base.xpi . -x "*.DS_Store" -x "*.git*" -x ".jshintrc" -x ".docx" -x "*.sh" -x "*publish*" -x "*node_modules*"
mv manifest.json publish/manifest-firefox.json

mv publish/manifest-firefox-onprem.json manifest.json
zip -r publish/snutils-firefox-onprem.xpi . -x "*.DS_Store" -x "*.git*" -x ".jshintrc" -x ".docx" -x "*.sh" -x "*publish*" -x "*node_modules*"
...
zip -r publish/snutils-edge-base.zip . -x "*.DS_Store" -x "*.git*" -x ".jshintrc" -x ".docx" -x "*.sh" -x "*publish*" -x "*node_modules*"
